        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            <?php elseif($row->type == "image"): ?>
                                <img class="img-responsive"
                                     src="<?php echo e(filter_var($dataTypeContent->{$row->field}, FILTER_VALIDATE_URL) ? $dataTypeContent->{$row->field} : asset('storage/'.($dataTypeContent->{$row->field}))); ?>">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                    <h3 class="panel-title">صور المشروع</h3>

                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>      
                    <div class="col-md-12 text-center" style="margin-bottom: 10px;">           
                    <img class="img-responsive"
                        src="<?php echo e(asset($image->img_path)); ?>" width="500px">
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>    
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/disk1/3779274/www/trustklusbedrijf.nl/resources/views/vendor/voyager/projects/read.blade.php ENDPATH**/ ?>