        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="footer-contact">
                    ...
                    <p><i class="fa fa-phone-alt"></i>+31 6 3333 0410</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="footer-link">
                    <h2>Useful Pages</h2>
                    <a href="<?php echo e(route('projects')); ?>"><?php echo e(__('lang.projects_gallery')); ?></a>
            ...
            <div class="col-md-6 col-lg-4">                
                <img src="<?php echo e(asset('img/logo_trans.png')); ?>" width="90%" height="100%">               
            </div>
...
<?php /**PATH /srv/disk1/3779274/www/trustklusbedrijf.nl/resources/views/front/include/footer.blade.php ENDPATH**/ ?>