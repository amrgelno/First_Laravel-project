<head>
    <meta charset="utf-8">
    <title>Trust Klusbedrijf</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Construction Company Website Template" name="keywords">
    <meta content="Construction Company Website Template" name="description">

    <!-- Favicon -->
    <link href="<?php echo e(asset('img/logo_dark.png')); ?>" rel="icon">
    ...
    <link href="<?php echo e(asset('fonts/all.min.css')); ?>" rel="stylesheet">
...
</head><?php /**PATH /srv/disk1/3779274/www/trustklusbedrijf.nl/resources/views/front/include/head.blade.php ENDPATH**/ ?>