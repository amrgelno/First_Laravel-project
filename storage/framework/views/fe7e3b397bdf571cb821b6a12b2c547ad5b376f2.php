                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group  col-md-12 " >
                                <label class="control-label" for="name">صور المشروع</label>
                                <br>
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <div class="img_settings_container" data-field-name="img_path" style="float:left;padding-right:15px;">
                                    <a href="#" class="voyager-x remove-multi-image" style="position: absolute;"></a>
                                    <img src="<?php echo e(asset($image->img_path)); ?>" data-file-name="<?php echo e($image->img_path); ?>" data-id="<?php echo e($image->id); ?>" style="max-width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:5px;">
                                </div>
                            ...
                            <div class="form-group  col-md-12 " >
                                ...
                                <label class="control-label" for="name">تحميل صور أخرى</label>
                                    <br>
                                    <div class="clearfix"></div>
                                    <input type="file" name="img_path[]" multiple="multiple" accept="image/*">
                            </div>
    ...
    <script>
        ...
        function deleteHandler(tag, isMulti) {
          return function() {
            ...
            // $file_name_array = $file.data('file-name').split("/");
            // $file_name = $file_name_array[3];

            params = {
                slug:   'projects_images',
                // filename:  $file_name,
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/disk1/3779274/www/trustklusbedrijf.nl/resources/views/vendor/voyager/projects/edit-add.blade.php ENDPATH**/ ?>